...
# Derived from https://raw.githubusercontent.com/yannh/kubeconform/refs/heads/master/scripts/openapi2jsonschema.py
import yaml
import json
import sys
import os
...
def write_schema_file(schema, filename):
    ...
    # Ensure any sub-directories exist before creating the file
